  ...
  return (
    <div >
      <div className="header ">
        <div className="logo-container w-12 ">
          <NavLink to="/">
            <img src={logo} alt="Logo " />
          </NavLink>
          {/* <div className="size-15 object-cover">
          <img src="https://www.shutterstock.com/image-vector/craving-logo-designs-text-art-600nw-1919290940.jpg"/>
